...
#Allow the end user to add the fruit to list
...
streamlit.text_input('What fruit would you like add?')
insert_val = insert_row_snowflake()
streamlit.dataframe("Data inserted "+ insert_val)
